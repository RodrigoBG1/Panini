...
export default function RepetidasScreen() {
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      {/* Filters */}
      <div style={{ padding: '14px 16px 10px', background: '#0d0d24', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: 40 }}>
            ...
            <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.35)' }}>
              {stickers.length === 0 ? 'Aún no tienes estampas repetidas' : 'Sin resultados'}
            </div>
          </div>
        ) : (
